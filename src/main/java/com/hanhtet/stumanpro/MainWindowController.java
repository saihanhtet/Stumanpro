...
public class MainWindowController {
  ...
  private void logoutPageFunction(ActionEvent event) {
    ...
    try {
      ...
      CustomAlertBox.showAlert(
        ...
        "User can't log out!!",
        "User can't log out!",
        "User don't have permission to logout as user wish!"
      );
    }
  }
  ...
  private void addCourse(ActionEvent event) {
    ...
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("course_add.fxml")
      );
      Parent root = loader.load();
      Scene scene = new Scene(root);
  ...
  private void userRegistration(ActionEvent event) {
    ...
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("user_add.fxml")
      );
      Parent root = loader.load();
      Scene scene = new Scene(root);
  ...
  private void viewCourses(ActionEvent event) {
    ...
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("course_view.fxml")
      );
      Parent root = loader.load();
      Scene scene = new Scene(root);
      courseStage.setScene(scene);
  ...
  private void deleteUser(ActionEvent event) {
    ...
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("user_delete.fxml")
      );
      Parent root = loader.load();
      Scene scene = new Scene(root);
      userStage.setScene(scene);
  ...
  private void deleteCourses(ActionEvent event) {
    ...
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("course_delete.fxml")
      );
      Parent root = loader.load();
      Scene scene = new Scene(root);
      courseStage.setScene(scene);
  ...
  private void syncFunction(ActionEvent event) {
    ...
    if (!result) {
      ...
      CustomAlertBox.showAlert(
        ...
        primaryStage,
        "Error at syncing!!",
        "Error occurred at Uploading the Local data to Google Sheet!",
  ...
  private void initialize() {
    assert sidebar !=
    null : "fx:id=\"sidebar\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert welcomeName !=
    null : "fx:id=\"welcomeName\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert route !=
    null : "fx:id=\"route\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert homePage !=
    null : "fx:id=\"homePage\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert frontTableView !=
    null : "fx:id=\"frontTableView\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert managementPage !=
    null : "fx:id=\"managementPage\" was not injected: check your FXML file 'mainwindow.fxml'.";
    assert studentManagePage !=
    null : "fx:id=\"studentManagePage\" was not injected: check your FXML file 'mainwindow.fxml'.";
