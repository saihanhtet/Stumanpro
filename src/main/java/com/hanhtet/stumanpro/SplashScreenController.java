...
public class SplashScreenController {
  ...
  void initialize() {
    assert LogoName !=
    null : "fx:id=\"LogoName\" was not injected: check your FXML file 'SplashScreen.fxml'.";
    assert SplashProgress !=
    null : "fx:id=\"SplashProgress\" was not injected: check your FXML file 'SplashScreen.fxml'.";
