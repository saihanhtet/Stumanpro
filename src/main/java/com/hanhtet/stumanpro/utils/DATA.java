...
public class DATA {
    ...
    public final static String USER_TABLE_RANGE = "user!A2:I";
    public final static String COURSE_TABLE_ID = "113zUxWYSAafV11QAyoeozsD1YFUf4Jqt_Hfv4-vblsM";
    public final static String COURSE_TABLE_RANGE = "course!A2:C";
    ...
    public final static String FILE_PATH = "/.stumanpro/data";
}
