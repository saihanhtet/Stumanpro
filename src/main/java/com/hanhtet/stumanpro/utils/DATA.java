...
public class DATA {
    ...
    public static final String TOKEN_PATH = SOURCE_DIR+ File.separator+"tokens";
    public static final String FILE_PATH = SOURCE_DIR+ File.separator + "tables";
    public static final String GOOGLE_SHEETSDIRECTORY = SOURCE_DIR+ File.separator +"sheetId";
    ...
    static {
        ...
        GOOGLE_SHEETS_DIRECTORY = System.getProperty(DATA.HOME) + DATA.GOOGLE_SHEETSDIRECTORY;
    }
