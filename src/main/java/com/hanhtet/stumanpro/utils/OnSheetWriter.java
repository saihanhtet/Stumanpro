...
public class OnSheetWriter {
  ...
  public static void writeSpreadsheetInfoToFile(
    ...
    String filePath =
      DATA.GOOGLE_SHEETS_DIRECTORY + File.separator + "sheetId.txt";
  ...
  private static Credential getCredentials(
    ...
    GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
      ...
      .setDataStoreFactory(
        new FileDataStoreFactory(new File(DATA.TOKENS_DIRECTORY_PATH))
      )
  ...
  public static void appendDataToSheet(
    @NotNull List<List<Object>> newData,
    String spreadsheetId,
    String range
  ) throws IOException {
  ...
  public static void downloadFile(
    ...
    try {
      Map<Integer, Object> responseDataOld = SheetUtils.readFromSheetFull(
        spreadsheetId,
        range
      );
  ...
  public static void syncWithLocalSheet(
    ...
    try {
      ...
      List<List<Object>> newData = (List<List<Object>>) resultData.get(1);
      String filePath =
        DATA.DOWNLOAD_XLXS_FOLDER_PATH + File.separator + sheetName + ".xlsx";
      List<List<Object>> localData = OffSheetWriter.readData(filePath);
      if (!newData.equals(localData)) {
