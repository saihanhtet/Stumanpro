...
public class OffSheetWriter {
    public static void createSheet(List<List<Object>> data, String filePath, String sheetName) {
    ...
    public static void appendDataToFile(List<List<Object>> newData, String filePath) {
        try {
    ...
    public static void deleteDataById(String id, String filePath) {
        try {
            FileInputStream fileInputStream = new FileInputStream(filePath);
            Workbook workbook = new XSSFWorkbook(fileInputStream);
    ...
    public static void editDataById(String id, List<Object> newData, String filePath) {
        try {
            FileInputStream fileInputStream = new FileInputStream(filePath);
            Workbook workbook = new XSSFWorkbook(fileInputStream);
            Sheet sheet = workbook.getSheetAt(0);
